...
import { Calendar, Clock, Pencil, Power, ArchiveRestore, Trash2 } from "lucide-react";
...
export const PipelineCard = ({
  ...
  return (
    ...
    >
      {/* Column 1: Name and Description (col-span-6) */}
      <div className="col-span-6 min-w-0 w-full">
        ...
        <p className="text-sm text-texto-secundario mt-1 truncate h-[20px] leading-normal">
          {displayDesc || <span className="italic text-texto-secundario/60">Sem descrição informada.</span>}
        </p>
      </div>
      ...
      <div className="col-span-3 flex flex-col gap-1 w-full text-xs text-texto-secundario">
      ...
      >
        {pipeline.ativo ? (
          <>
            ...
            <Tooltip title="Desativar Pipeline" arrow slotProps={tooltipSlotProps}>
              <IconButton
                size="medium"
